...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.fireComputerBullets = function() {
	  ...
	  if (this.enemies.length > 1) {
	    ...
	    this.computerBullets.push(new Bullet({position: [pos1[0] + 10, pos1[1] + 40], game: this, dy: [0, 10], imgsrc: './images/computer_bullet.png'}));
	    this.computerBullets.push(new Bullet({position: [pos2[0] + 10, pos2[1] + 40], game: this, dy: [0, 10], imgsrc: './images/computer_bullet.png'}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	Enemy.prototype.collideWith = function(otherObject){
	  console.log("in the enemy collide with");
	  if (otherObject instanceof Bullet) {
	    delete this;
	    delete otherObject;
	    return true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	MovingObject.prototype.move = function(delta) {
	  ...
	  if (delta) {
	    ...
	    this.position[0] = Math.max(10, Math.min(this.position[0], this.game.DIM_X - 50));
	  }
	};
	...
	MovingObject.prototype.collideWith = function (otherObject) {
	  // default do nothing
	  // console.log("collision from the moving object.js file!");
	};
